<div class="btn-soporte">
    <div class="icon-content">
        <a data-social="soporte" aria-label="Soporte" href="https://zfrmz.com/69heWylxw9fFtIS7oOmD" target="_blank">
            <div class="filled"></div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 112.92" version="1.1">
